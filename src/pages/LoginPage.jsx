 ...
 * LOGIN PAGE
 * ----------
 * Handles manual login (email/pass) + provides a link to Google OAuth2.
...
export default function LoginPage() {
  ...
  // Show "Registration successful" message if redirected from Register
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // data typically contains { token, userId, username, email, roles, ... }
      login(data);
      navigate('/dashboard');
    } catch (err) {
  ...
  return (
    <div className="auth-page animate-reveal">
      <div className="auth-card glass">
        ...
        {registered && (
          <div className="success-banner animate-reveal">
